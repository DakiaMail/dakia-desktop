...
## Dakia source availability

Dakia is licensed under the Mozilla Public License 2.0. Its source code is
available at https://github.com/DakiaMail/dakia-desktop. The packaged
`licenses/DAKIA-MPL-2.0-SOURCE-NOTICE.md` records this notice alongside the
complete MPL 2.0 text.
